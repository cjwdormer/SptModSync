...
using TCFModSync.Updater.Apply;
using TCFModSync.Updater.Logging;

var exeDir = AppContext.BaseDirectory;
using var log = new UpdaterLog(Path.Combine(exeDir, "TCFModSync.Updater.log"));
...
{
    var candidate = Path.Combine(exeDir, "TCFModSync.pending.json");
